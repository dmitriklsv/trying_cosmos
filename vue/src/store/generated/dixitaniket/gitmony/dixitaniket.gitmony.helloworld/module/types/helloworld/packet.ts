...
const baseHelloworldPacketData: object = {}

export const HelloworldPacketData = {
  encode(message: HelloworldPacketData, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): HelloworldPacketData {
    ...
    const message = { ...baseHelloworldPacketData } as HelloworldPacketData
